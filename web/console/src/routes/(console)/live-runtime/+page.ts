// Live Runtime page — load function (Phase 73b / D-126).
//
// The Console is a client-side SPA (D-091) — no SSR. The Live Runtime
// page's connection + identity + scope resolve client-side from
