...
#
# Phase 211 smoke template. Copy to phase-211.sh, set the surface assertions, make executable.
#
#   cp scripts/smoke/_template.sh scripts/smoke/phase-211.sh
#   chmod +x scripts/smoke/phase-211.sh
#
...
# ----------------------------------------------------------------------------
# Phase 211 assertions go below. Examples:
#
...
# `skip "phase 211: not yet implemented"` to keep preflight green.
# ----------------------------------------------------------------------------

skip "phase 211: smoke skeleton — replace with real assertions when the phase implements its surface"
