...
#
# Phase 214 smoke template. Copy to phase-214.sh, set the surface assertions, make executable.
#
#   cp scripts/smoke/_template.sh scripts/smoke/phase-214.sh
#   chmod +x scripts/smoke/phase-214.sh
#
...
# ----------------------------------------------------------------------------
# Phase 214 assertions go below. Examples:
#
...
# `skip "phase 214: not yet implemented"` to keep preflight green.
# ----------------------------------------------------------------------------

skip "phase 214: smoke skeleton — replace with real assertions when the phase implements its surface"
