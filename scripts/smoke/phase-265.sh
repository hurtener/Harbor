...
assert_grep_present '## D-450' "docs/decisions.md" "D-450 decision exists"
...
assert_grep_present 'AgentConfigUserReconcileLiveProfileRequest' "internal/protocol/types/agentconfig.go" "user live-profile reconcile wire type exists"
...
assert_grep_present 'user/reconcile_live_profile' "internal/protocol/transports/stream/agentconfig_handler.go" "user live-profile reconcile route exists"
...
assert_grep_present 'TestUserReconcileLiveProfileReturnsFreshRevisionAfterConcurrentRemoval' "internal/runtime/agentcfg/protocol/user_reconcile_live_profile_test.go" "live-profile concurrent removal is covered"
...
assert_grep_present 'AgentConfigUserReconcileLiveProfileRequest' "docs/site/protocol/types.md" "generated type reference includes live-profile reconcile"
...
assert_grep_present 'agent_config.user.reconcile_live_profile' "docs/site/protocol/methods.md" "generated method reference includes live-profile reconcile"
