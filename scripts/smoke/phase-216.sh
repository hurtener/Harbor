...
#
# Phase 216 smoke template. Copy to phase-216.sh, set the surface assertions, make executable.
#
#   cp scripts/smoke/_template.sh scripts/smoke/phase-216.sh
#   chmod +x scripts/smoke/phase-216.sh
#
...
# ----------------------------------------------------------------------------
# Phase 216 assertions go below. Examples:
#
...
# `skip "phase 216: not yet implemented"` to keep preflight green.
# ----------------------------------------------------------------------------

skip "phase 216: smoke skeleton — replace with real assertions when the phase implements its surface"
