...
#
# Phase NN smoke template. Copy to phase-112a.sh, set the surface assertions, make executable.
#
#   cp scripts/smoke/_template.sh scripts/smoke/phase-112a.sh
#   chmod +x scripts/smoke/phase-112a.sh
#
...
# `skip "phase 112a: not yet implemented"` to keep preflight green.
# ----------------------------------------------------------------------------

skip "phase 112a: smoke skeleton — replace with real assertions when the phase implements its surface"
