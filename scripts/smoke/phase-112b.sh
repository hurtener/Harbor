...
#
# Phase NN smoke template. Copy to phase-112b.sh, set the surface assertions, make executable.
#
#   cp scripts/smoke/_template.sh scripts/smoke/phase-112b.sh
#   chmod +x scripts/smoke/phase-112b.sh
#
...
# `skip "phase 112b: not yet implemented"` to keep preflight green.
# ----------------------------------------------------------------------------

skip "phase 112b: smoke skeleton — replace with real assertions when the phase implements its surface"
