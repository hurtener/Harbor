...
# entries with no arguments/results, and a separate named activity method is
# not a v1.28 method or acceptance — any future named fallback is a deferred
# follow-up; cross-identity turns are typed not-found).
set -euo pipefail
