...
#
# Phase 217 smoke template. Copy to phase-217.sh, set the surface assertions, make executable.
#
#   cp scripts/smoke/_template.sh scripts/smoke/phase-217.sh
#   chmod +x scripts/smoke/phase-217.sh
#
...
# ----------------------------------------------------------------------------
# Phase 217 assertions go below. Examples:
#
...
# `skip "phase 217: not yet implemented"` to keep preflight green.
# ----------------------------------------------------------------------------

skip "phase 217: smoke skeleton — replace with real assertions when the phase implements its surface"
