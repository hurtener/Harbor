...
#
# Phase 208 smoke template. Copy to phase-208.sh, set the surface assertions, make executable.
#
#   cp scripts/smoke/_template.sh scripts/smoke/phase-208.sh
#   chmod +x scripts/smoke/phase-208.sh
#
...
# ----------------------------------------------------------------------------
# Phase 208 assertions go below. Examples:
#
...
# `skip "phase 208: not yet implemented"` to keep preflight green.
# ----------------------------------------------------------------------------

skip "phase 208: smoke skeleton — replace with real assertions when the phase implements its surface"
