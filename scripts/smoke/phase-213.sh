...
#
# Phase 213 smoke template. Copy to phase-213.sh, set the surface assertions, make executable.
#
#   cp scripts/smoke/_template.sh scripts/smoke/phase-213.sh
#   chmod +x scripts/smoke/phase-213.sh
#
...
# ----------------------------------------------------------------------------
# Phase 213 assertions go below. Examples:
#
...
# `skip "phase 213: not yet implemented"` to keep preflight green.
# ----------------------------------------------------------------------------

skip "phase 213: smoke skeleton — replace with real assertions when the phase implements its surface"
