...
#
# Phase 212 smoke template. Copy to phase-212.sh, set the surface assertions, make executable.
#
#   cp scripts/smoke/_template.sh scripts/smoke/phase-212.sh
#   chmod +x scripts/smoke/phase-212.sh
#
...
# ----------------------------------------------------------------------------
# Phase 212 assertions go below. Examples:
#
...
# `skip "phase 212: not yet implemented"` to keep preflight green.
# ----------------------------------------------------------------------------

skip "phase 212: smoke skeleton — replace with real assertions when the phase implements its surface"
