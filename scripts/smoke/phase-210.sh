...
#
# Phase 210 smoke template. Copy to phase-210.sh, set the surface assertions, make executable.
#
#   cp scripts/smoke/_template.sh scripts/smoke/phase-210.sh
#   chmod +x scripts/smoke/phase-210.sh
#
...
# ----------------------------------------------------------------------------
# Phase 210 assertions go below. Examples:
#
...
# `skip "phase 210: not yet implemented"` to keep preflight green.
# ----------------------------------------------------------------------------

skip "phase 210: smoke skeleton — replace with real assertions when the phase implements its surface"
