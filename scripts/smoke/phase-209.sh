...
#
# Phase 209 smoke template. Copy to phase-209.sh, set the surface assertions, make executable.
#
#   cp scripts/smoke/_template.sh scripts/smoke/phase-209.sh
#   chmod +x scripts/smoke/phase-209.sh
#
...
# ----------------------------------------------------------------------------
# Phase 209 assertions go below. Examples:
#
...
# `skip "phase 209: not yet implemented"` to keep preflight green.
# ----------------------------------------------------------------------------

skip "phase 209: smoke skeleton — replace with real assertions when the phase implements its surface"
