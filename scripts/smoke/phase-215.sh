...
#
# Phase 215 smoke template. Copy to phase-215.sh, set the surface assertions, make executable.
#
#   cp scripts/smoke/_template.sh scripts/smoke/phase-215.sh
#   chmod +x scripts/smoke/phase-215.sh
#
...
# ----------------------------------------------------------------------------
# Phase 215 assertions go below. Examples:
#
...
# `skip "phase 215: not yet implemented"` to keep preflight green.
# ----------------------------------------------------------------------------

skip "phase 215: smoke skeleton — replace with real assertions when the phase implements its surface"
