...
- [ ] If multi-isolation paths changed: cross-session isolation test passes (the schema is identity-scoped task state; the conformance + E2E identity legs cover the seam)
