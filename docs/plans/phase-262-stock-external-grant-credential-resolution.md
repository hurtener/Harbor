...
## v1.30.3 release-candidate evidence

Phase 262 landed at exact current `origin/main`
`415d353d740ff3c3c2da8e3432eea342f7ccdeb2` through PR #750. Pre-merge PR run
`32882992600` had two unrelated Go failures: the macOS
...
day. No tag, release assets, module provenance, post-tag scaffold cleanup,
