...
Governance amendment (HA-54 planner-replay gap): the classified outcome must survive the runloop's step recording and appear in the actual next ReAct prompt; a generic step error never masks the classified observation.
...
Governance amendment (HA-54 planner-replay gap) — file/test ownership:
...
- 26b and 28; independent of 237, 238, 240, 241, and 242; gates 239.
