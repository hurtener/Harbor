...
- **Evidence:** The focused LLM/config/assembly/SDK suites, assembled
  ...
  are release prerequisites. The implementation is based on merged Harbor
  main `56f13da5813adf134692d95bf091e0a8c97680a7`; v1.30.1 tag, release
  assets, checksums, public module provenance, hosted release workflow, and
  downstream acceptance remain unclaimed.
- **Decision:** D-436. **Status:** Implementation candidate; no release claim.
