...
|113a| Protocol adoption track — generated contract reference (`cmd/harbor-gen-protocol-docs` + `protocol-docs-gen-check` gate) + the executed quickstart + choreographies 1–3 + nav/README/§18 | cmd/harbor-gen-protocol-docs + docs/site + workflows | §5, §3.6 | 103, 58, 59, 60, 61, 62, 110c | 70% | Pending (V1.3.x) |
|113b| Protocol adoption track — pause + versioning choreographies, build-a-client (worked event-viewer + compile gate), conformance-certification page | docs/site + examples/protocol-clients | §5, §3.3, §6.3 | 113a, 50, 72e, 111b, 111c, 84a | n/a | Pending (V1.3.x) |
