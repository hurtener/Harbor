...
- **RFC:** §6.4 (tool-side OAuth; the "External tool-credential provisioning
  (planned — D-271)" paragraph), §3.3 (the unified pause primitive the
