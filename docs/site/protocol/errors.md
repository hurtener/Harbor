...
The 18 canonical Harbor Protocol error codes, generated from the single-source
...
| `invalid_request` | 400 | The request was structurally malformed: undecodable JSON, a wrong wire shape for the method, an out-of-range field, or an agent-pack draft whose exact reviewed hash, provenance, or single-use proposal receipt is invalid. | No — fix the request shape or restart the propose/commit review. |
