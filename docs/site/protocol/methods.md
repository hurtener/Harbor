...
| `agent_config.user.reconcile_live_profile` | `POST /v1/agent_config/user/reconcile_live_profile` | agent config — user | [`AgentConfigUserReconcileLiveProfileRequest`](./types.md#agentconfiguserreconcileliveprofilerequest) | [`AgentConfigUserReconcileLiveProfileResponse`](./types.md#agentconfiguserreconcileliveprofileresponse) | mutating; identity-mandatory; requires the verified `agent_config:user` scope claim (NOT admin — the durable per-user variant tier); signed reach to the target agent is required |
| `agent_config.user.register_oauth_mcp_capability` | `POST /v1/agent_config/user/register_oauth_mcp_capability` | agent config — user | [`AgentConfigUserRegisterOAuthMCPCapabilityRequest`](./types.md#agentconfiguserregisteroauthmcpcapabilityrequest) | [`AgentConfigUserRegisterOAuthMCPCapabilityResponse`](./types.md#agentconfiguserregisteroauthmcpcapabilityresponse) | mutating; identity-mandatory; requires the verified `agent_config:user` scope claim (NOT admin — the durable per-user variant tier); signed reach to the target agent is required |
| `agent_config.user.remove_oauth_mcp_capability` | `POST /v1/agent_config/user/remove_oauth_mcp_capability` | agent config — user | [`AgentConfigUserRemoveOAuthMCPCapabilityRequest`](./types.md#agentconfiguserremoveoauthmcpcapabilityrequest) | [`AgentConfigUserRemoveOAuthMCPCapabilityResponse`](./types.md#agentconfiguserremoveoauthmcpcapabilityresponse) | mutating; identity-mandatory; requires the verified `agent_config:user` scope claim (NOT admin — the durable per-user variant tier); signed reach to the target agent is required |
