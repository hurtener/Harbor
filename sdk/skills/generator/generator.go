...
// trajectory (RFC §3.6, §6.7). Alias-based re-exports
// only: no behavior lives here. Part of the one skills surface
// alongside sdk/skills/tools (the recipe registers
