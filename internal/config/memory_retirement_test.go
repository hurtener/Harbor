...
func TestMemoryRetirement_RejectsSemanticIndexConfiguration(t *testing.T) {
	...
	for _, field := range []string{"retrieval: semantic", "retrieval: ''", "retrieval_top_k: 5", "retrieval_top_k: 0", "retrieval_min_score: 0.4", "retrieval_min_score: 0", "recovery_backlog_max: 0", "recovery_backlog_max: 16", "strategy: truncation"} {
	...
	for _, key := range []string{"HARBOR_MEMORY_RETRIEVAL", "HARBOR_MEMORY_RETRIEVAL_TOP_K", "HARBOR_MEMORY_RETRIEVAL_MIN_SCORE", "HARBOR_MEMORY_RECOVERY_BACKLOG_MAX"} {
