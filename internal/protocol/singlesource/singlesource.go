...
var CanonicalMethods = map[string]struct{}{
	...
	// agent-config control-plane cluster.
	"agent_config.get":                           {},
...
var CanonicalWireTypes = map[string]string{
	...
	"LLMProviderRouteObservation":    "types",
	...
	"AgentConfigAgentPacksInspectRequest":               "types",
	"AgentConfigAgentPackInspection":                    "types",
	"AgentConfigAgentPacksInspectResponse":              "types",
	"AgentConfigAgentPacksCopyRequest":                  "types",
	"AgentConfigAgentPackCopyOutcome":                   "types",
	"AgentConfigAgentPacksCopyResponse":                 "types",
	...
	"AgentConfigUserRegisterOAuthMCPCapabilityRequest":  "types",
	"AgentConfigUserRegisterOAuthMCPCapabilityResponse": "types",
	"AgentConfigUserRemoveOAuthMCPCapabilityRequest":    "types",
	"AgentConfigUserRemoveOAuthMCPCapabilityResponse":   "types",
	"AgentConfigUserReconcileLiveProfileRequest":        "types",
	"AgentConfigUserReconcileLiveProfileResponse":       "types",
