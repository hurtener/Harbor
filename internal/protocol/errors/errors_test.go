...
func TestErrorCodes_StableWireStrings(t *testing.T) {
	...
	wire := map[protoerrors.Code]string{
		...
		protoerrors.CodeRestartUnavailable:               "restart_unavailable",
		protoerrors.CodeRetainedContextUnsettled:         "retained_context_unsettled",
		protoerrors.CodeRetainedContextUnavailable:       "retained_context_unavailable",
		...
		protoerrors.CodeAgentPackCopyConflict:            "agent_pack_copy_conflict",
		protoerrors.CodeAgentPackCopyIdempotencyConflict: "agent_pack_copy_idempotency_conflict",
