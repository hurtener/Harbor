...
// echoTool returns an Invoke function that echoes args under
...
func echoTool(name string) func(ctx context.Context, args json.RawMessage) (tools.ToolResult, error) {
	return func(_ context.Context, args json.RawMessage) (tools.ToolResult, error) {
...
func TestExecute_JoinAll_AllSucceed(t *testing.T) {
	...
	for _, n := range []string{"alpha", "beta", "gamma"} {
		resolver.Register(n, echoTool(n), nil)
	}
