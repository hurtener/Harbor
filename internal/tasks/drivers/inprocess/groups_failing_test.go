...
func (f *failingStateStore) ListKindBounded(ctx context.Context, scope state.ListScope, kindPrefix string, limit int) ([]state.StateRecord, error) {
...
func (f *failingStateStore) ListKindForIdentityBounded(ctx context.Context, id identity.Quadruple, kindPrefix string, limit int) ([]state.StateRecord, error) {
	return f.inner.ListKindForIdentityBounded(ctx, id, kindPrefix, limit)
}
